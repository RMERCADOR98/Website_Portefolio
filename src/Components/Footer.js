            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-sm" >
                        ...
                        <br/>
                        <Link style={{textDecoration:"none", color:"black"}}>Projects</Link>
                        <br/>
                        <Link style={{textDecoration:"none", color:"black"}}>Contact</Link>
                    </div>
                    <div class="col-sm">Harooo</div>
                </div>
                <span class="text-center justify-content-center d-flex pt-4 pb-2">2020 Copyright &nbsp; <span><BiCopyright/></span>&nbsp;<b>Rodrigo Mercador</b></span>
            </div>
